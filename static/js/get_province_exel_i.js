    ...
    req.onreadystatechange = function () {
        if (req.readyState == 4) {
            if (req.status == 200) {
                ...
                if (src == 'province') {
                    html = "<select form='mso_form' class='form-control form-select' name='i_province' onChange=\"dochange1('district', this.value)\">";
                    ...
                    html = "<select form='mso_form' class='form-control form-select' name='i_district' onChange=\"dochange1('sub_district', this.value)\">";
                    ...
                    html = "<select form='mso_form' class='form-control form-select' name='i_sub_district' onChange=\"dochange1('postcode', this.value)\">";
                    ...
                    for (key in jsonResponse['postcode']) {
                        ...
                        html = "<input form='mso_form' type='text' name='i_zipcode' class='form-control' value='" + value + "'' readonly>";
                    }
    ...
    req.onreadystatechange = function () {
        if (req.readyState == 4) {
            if (req.status == 200) {
                ...
                if (src == 'province') {
                    html = "<select form='mso_form' class='form-control form-select' name='i_province_now' onChange=\"dochange2('district', this.value)\">";
                    html += "<option value=''>- เลือกจังหวัด -</option>\n";
                    var data = req.responseText;
                    var jsonResponse = JSON.parse(data);
                    ...
                    html = "<select form='mso_form' class='form-control form-select' name='i_district_now' onChange=\"dochange2('sub_district', this.value)\">";
                    html += "<option value=''>- เลือกอำเภอ -</option>\n";
                    var data = req.responseText;
                    var jsonResponse = JSON.parse(data);
                    ...
                    html = "<select form='mso_form' class='form-control form-select' name='i_sub_district_now' onChange=\"dochange2('postcode', this.value)\">";
                    html += "<option value=''>- เลือกตำบล -</option>\n";
                    var data = req.responseText;
                    var jsonResponse = JSON.parse(data);
                    ...
                    for (key in jsonResponse['postcode']) {
                        value = jsonResponse['postcode'][key]['fields']['postcode'];
                        html = "<input form='mso_form' type='text' name='i_zipcode_now' class='form-control' value='" + value + "'' readonly>";
                    }
    ...
    req.onreadystatechange = function () {
        if (req.readyState == 4) {
            if (req.status == 200) {
                ...
                if (src == 'province') {
                    html = "<select form='mso_form' class='form-control form-select' name='p_province' onChange=\"dochange3('district', this.value)\">";
                    html += "<option value=''>- เลือกจังหวัด -</option>\n";
                    var data = req.responseText;
                    var jsonResponse = JSON.parse(data);
                    ...
                    html = "<select form='mso_form' class='form-control form-select' name='p_district' onChange=\"dochange3('sub_district', this.value)\">";
                    html += "<option value=''>- เลือกอำเภอ -</option>\n";
                    var data = req.responseText;
                    var jsonResponse = JSON.parse(data);
                    ...
                    html = "<select form='mso_form' class='form-control form-select' name='p_sub_district' onChange=\"dochange3('postcode', this.value)\">";
                    html += "<option value=''>- เลือกตำบล -</option>\n";
                    var data = req.responseText;
                    var jsonResponse = JSON.parse(data);
                    ...
                    for (key in jsonResponse['postcode']) {
                        value = jsonResponse['postcode'][key]['fields']['postcode'];
                        html = "<input form='mso_form' type='text' name='p_zipcode' class='form-control' value='" + value + "'' readonly>";
                    }
    ...
    req.onreadystatechange = function () {
        if (req.readyState == 4) {
            if (req.status == 200) {
                ...
                if (src == 'province') {
                    html = "<select form='mso_form' class='form-control form-select' name='p_province_now' onChange=\"dochange4('district', this.value)\">";
                    html += "<option value=''>- เลือกจังหวัด -</option>\n";
                    var data = req.responseText;
                    var jsonResponse = JSON.parse(data);
                    ...
                    html = "<select form='mso_form' class='form-control form-select' name='p_district_now' onChange=\"dochange4('sub_district', this.value)\">";
                    html += "<option value=''>- เลือกอำเภอ -</option>\n";
                    var data = req.responseText;
                    var jsonResponse = JSON.parse(data);
                    ...
                    html = "<select form='mso_form' class='form-control form-select' name='p_sub_district_now' onChange=\"dochange4('postcode', this.value)\">";
                    html += "<option value=''>- เลือกตำบล -</option>\n";
                    var data = req.responseText;
                    var jsonResponse = JSON.parse(data);
                    ...
                    for (key in jsonResponse['postcode']) {
                        value = jsonResponse['postcode'][key]['fields']['postcode'];
                        html = "<input form='mso_form' type='text' name='p_zipcode_now' class='form-control' value='" + value + "'' readonly>";
                    }
