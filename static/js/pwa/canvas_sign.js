...
function loadSign(ctx) {
    if (localStorage.getItem('case_' + get_maxcase())) {
        ...
        if (JSON.stringify(keys) != "{}") {
            ...
            image.src = "data:image/png;base64," + keys['sign']
        }
    }
}
