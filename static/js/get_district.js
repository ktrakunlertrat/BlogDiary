    ...
    req.onreadystatechange = function () {
        if (req.readyState == 4) {
            if (req.status == 200) {
                ...
                if (src == 'district') {
                    html = "<select class='form-control form-select' name='district' onChange=\"dochange('sub_district', this.value)\" required>";
                    ...
                    html = "<select class='form-control form-select' name='sub_district' onChange=\"dochange('postcode', this.value)\" required>";
                    ...
                    for (key in jsonResponse['postcode']) {
                        ...
                        html = "<input type='text' name='postcode' class='form-control form-select' value='" + value + "'' required readonly>";
                    }
