...
!function(n) {
    n.fn.AutoProvince = function(e) {
        ...
        return this.each(function() {
            var e, t, i, a, r, R = "./static/json/provinces.json", c = "./static/json/amphures.json", u = "./static/json/districts.json", T = "./static/json/zipcodes.json", C = "./static/json/geography.json";
            function d(e) {
                var i = []
                  , a = !0;
                n(o.AMPHUR).empty(),
